...
```{r,echo=F}
g3  <- g1 + coord_fixed(ratio=-1) + theme_classic() + labs(x=NULL, y=NULL)
g3
...
```{r worm,echo=F}
g4  <- g1 + coord_fixed(ratio=1) + theme_classic() + stat_function(fun=function (x) 5*sin(x)-8, color="red")  + ggtitle("Еда")
g4
```
